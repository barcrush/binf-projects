#### Markov Chains ########
# A program that generates a DNA sequence using a multinomial model of DNA sequence evolution, and then moves onto a Markov model of DNA sequence evolution.
###########################
...
plotData <- function(seq,
  ...
  # Count the frequency of each base in the sequence
  ...
  # Count the frequency of trinucleotides n
...
# Create a function to generate the first order sequence.
...
## initializing variables for makeViterimat and viterbi functions
#    sequence         = character vector for the sequence
#    transitionmatrix = matrix that stores the probability distribution of transitions
#    emissionmatrix   = matrix that stores the probability distribution of emissions

# creating makeViterbimat function
...
# creating viterbi function which uses matrix (v) from the previous function
...
##  plot the data for first order
plotData(firstOrderSeq, nucleotides, "Markov Chain of first order")

# Example of a H idden Markov Chain of first order
# (the current nucleotide only depends on the previous nucleotide).
...
hmmfirstOrderSeq <- generateFirstOrderhmmseq(10000, nucleotides, initialProb, 
                                             states, theTransitionMatrix, theEmissionMatrix)
