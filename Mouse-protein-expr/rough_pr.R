...
library(boot) # cv.glm
library(faraway) # compact lm summary "summary" function
...
# load_file_source("https://archive.ics.uci.edu/ml/machine-learning-databases/00342/Data_Cortex_Nuclear.xls", "Data_Cortex_Nuclear.csv")
